...
TABLE_C_TARGET = 'gt_las_All_match'
        ...
        for file_id in range(FILE_ID_START, FILE_ID_END + 1, 1):
            ...
            for a_row in table_a_results:
                if a_row['file_id'] == file_id:
                    table_a_row_list.append([a_row['file_id'], a_row['change_type'],
                                             a_row['node_type'], a_row['node_pos']])
            else:
            ...
            for b_row in table_b_results:
                if b_row['file_id'] == file_id:
                    table_b_row_list.append([b_row['file_id'], b_row['change_type'],
                                             b_row['node_type'], b_row['node_pos']])
            else:
